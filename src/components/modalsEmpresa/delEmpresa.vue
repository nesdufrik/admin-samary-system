			...
			<div class="modal-content">
				<div class="modal-body text-center">
					...
					<p>
						...
						<strong class="text-danger fs-5">{{ empresaForm.name }}</strong
						>, no podrás recuperarlo. Asegúrate de que realmente no necesitas
						esta información antes de continuar con la eliminación.
					</p>
				</div>
...
const { empresaForm, actionState, delEmpresa, cleanForm, cleanAndRedirect } =
	useEmpresas()
</script>
