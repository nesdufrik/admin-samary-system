<template>
	<div
		class="tarjeta bg-dark-subtle border-end border-dark-subtle border-5 rounded-3 text-end p-3 my-3"
	>
		<h1 class="fw-bold">{{ empresaData.name }}</h1>
		<p>
			Gestiona todas las sucursales de tu empresa de manera eficiente y sin
			complicaciones
		</p>
		<button
